...
export const mockStorage = {
    getFilePreview: vi.fn().mockReturnValue({ toString: () => 'http://localhost/preview' }),
    createFile: vi.fn(),
    deleteFile: vi.fn()
};
...
export const appwriteMockImplementation = {
    ...
    Account: vi.fn().mockImplementation(function() { return mockAccount; }),
    Databases: vi.fn().mockImplementation(function() { return mockDatabases; }),
