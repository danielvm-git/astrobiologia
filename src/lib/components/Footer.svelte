...
<footer class="border-t border-border bg-muted/30">
	<div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
		<div class="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
			...
			<!-- Newsletter -->
			<div>
				<h3 class="text-sm font-semibold uppercase tracking-wider text-foreground">Newsletter</h3>
		...
		<div class="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 md:flex-row">
			<p class="text-sm text-muted-foreground">
				&copy; {currentYear} Astrobiologia.com. Todos os direitos reservados.
			</p>
			<div class="flex items-center gap-4">
				<a
					href="mailto:contato@astrobiologia.com"
				...
				<a
					href="https://twitter.com/astrobiologia"
					target="_blank"
				...
				<a
					href="https://github.com/astrobiologia"
					target="_blank"
					rel="noopener noreferrer"
					class="text-muted-foreground transition-colors hover:text-primary"
					aria-label="GitHub"
