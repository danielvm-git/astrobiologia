<script lang="ts">
  ...
  const listLoadError = $derived(data.listLoadError === true);
...
<main class="min-h-screen bg-slate-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <div class="max-w-3xl mx-auto mb-12">
      <h1
        class="text-4xl md:text-5xl font-bold text-slate-900 mb-4 text-center"
      >
    ...
    {#if hasQuery}
      <ContentLoadErrorNotice show={listLoadError} />
      {#if !listLoadError && resultCount > 0}
